...
//  Scrumdinger
//
//  Created by Sanghun Park on 22.10.22.
//
...
///
/// The `ScrumTimer` class periodically updates the state of a meeting. The timer calls the `speakerChangedAction` closure when the speaker changes and shares other important state changes through `@Published` properties.
